...
public class Startup
{
    ...
    public Startup(IConfiguration configuration, IHostEnvironment hostEnvironment)
    {
        ...
        GitHubIssuer.WebAPI.SettingsProvider.Current = Helper.ReadAssemblyConfiguration<GitHubIssuer.WebAPI.Settings>(_jsonConfigurationFile);
        GitHubIssuer.Business.SettingsProvider.Current = Helper.ReadAssemblyConfiguration<GitHubIssuer.Business.Settings>(_jsonConfigurationFile);
    ...
    {
        services.SpiderlyConfigureServices<GitHubIssuerApplicationDbContext>();
    }
