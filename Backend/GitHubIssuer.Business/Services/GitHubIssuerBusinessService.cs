...
using GitHubIssuer.Business.DataMappers;
using GitHubIssuer.Business.ValidationRules;
...
{
    public class GitHubIssuerBusinessService : GitHubIssuer.Business.Services.BusinessServiceGenerated
    {
        private readonly IApplicationDbContext _context;
        private readonly GitHubIssuer.Business.Services.AuthorizationBusinessService _authorizationService;
        private readonly AuthenticationService _authenticationService;
        private readonly SecurityBusinessService<UserExtended> _securityBusinessService;
        private readonly EmailingService _emailingService;

        public GitHubIssuerBusinessService(
            IApplicationDbContext context, 
            ExcelService excelService, 
            GitHubIssuer.Business.Services.AuthorizationBusinessService authorizationService, 
