...
import { IssueBaseDetailsComponent } from 'src/app/business/components/base-details/business-base-details.generated';
...
@Component({
    ...
    imports: [
        ...
        IssueBaseDetailsComponent
    ]
})
export class IssueDetailsComponent extends BaseFormCopy implements OnInit {
    issueFormGroup = new SpiderlyFormGroup<Issue>({});
