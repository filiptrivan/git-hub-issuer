...
export class ValidatorServiceGenerated {
    ...
    setValidator = (formControl: SpiderlyFormControl, className: string): SpiderlyValidatorFn => {
        switch(formControl.label + className){
            case 'titleIssue':
                return this.titleIssueValidator(formControl);
            case 'descriptionIssue':
                return this.descriptionIssueValidator(formControl);
            case 'linkIssue':
                return this.linkIssueValidator(formControl);
            case 'versionIssue':
                return this.versionIssueValidator(formControl);
            case 'createdAtIssue':
                return this.createdAtIssueValidator(formControl);
            case 'modifiedAtIssue':
                return this.modifiedAtIssueValidator(formControl);

            case 'nameIssueLabel':
                return this.nameIssueLabelValidator(formControl);
            case 'descriptionIssueLabel':
                return this.descriptionIssueLabelValidator(formControl);
            case 'versionIssueLabel':
                return this.versionIssueLabelValidator(formControl);
            case 'createdAtIssueLabel':
                return this.createdAtIssueLabelValidator(formControl);
            case 'modifiedAtIssueLabel':
                return this.modifiedAtIssueLabelValidator(formControl);
    ...
    titleIssueValidator = (control: SpiderlyFormControl): SpiderlyValidatorFn => {
    ...
    descriptionIssueValidator = (control: SpiderlyFormControl): SpiderlyValidatorFn => {
        const validator: SpiderlyValidatorFn = (): ValidationErrors | null => {
            const value = control.value;
    ...
    linkIssueValidator = (control: SpiderlyFormControl): SpiderlyValidatorFn => {
        const validator: SpiderlyValidatorFn = (): ValidationErrors | null => {
            const value = control.value;
    ...
    versionIssueValidator = (control: SpiderlyFormControl): SpiderlyValidatorFn => {
        const validator: SpiderlyValidatorFn = (): ValidationErrors | null => {
            const value = control.value;
    ...
    createdAtIssueValidator = (control: SpiderlyFormControl): SpiderlyValidatorFn => {
        const validator: SpiderlyValidatorFn = (): ValidationErrors | null => {
            const value = control.value;
    ...
    modifiedAtIssueValidator = (control: SpiderlyFormControl): SpiderlyValidatorFn => {
        const validator: SpiderlyValidatorFn = (): ValidationErrors | null => {
            const value = control.value;
    ...
    nameIssueLabelValidator = (control: SpiderlyFormControl): SpiderlyValidatorFn => {
        const validator: SpiderlyValidatorFn = (): ValidationErrors | null => {
            const value = control.value;
    ...
    descriptionIssueLabelValidator = (control: SpiderlyFormControl): SpiderlyValidatorFn => {
        const validator: SpiderlyValidatorFn = (): ValidationErrors | null => {
            const value = control.value;
    ...
    versionIssueLabelValidator = (control: SpiderlyFormControl): SpiderlyValidatorFn => {
        const validator: SpiderlyValidatorFn = (): ValidationErrors | null => {
            const value = control.value;
    ...
    createdAtIssueLabelValidator = (control: SpiderlyFormControl): SpiderlyValidatorFn => {
        const validator: SpiderlyValidatorFn = (): ValidationErrors | null => {
            const value = control.value;
    ...
    modifiedAtIssueLabelValidator = (control: SpiderlyFormControl): SpiderlyValidatorFn => {
        const validator: SpiderlyValidatorFn = (): ValidationErrors | null => {
            const value = control.value;
